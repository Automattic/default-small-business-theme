...
function logo_awesomeness_customize_register( $wp_customize ) {
	...
	$wp_customize->add_control( 'logo_size', array(
		'label'       => esc_html__( 'Logo Size', 'business-elegant' ),
...
function logo_awesomeness_customize_preview_js() {
	wp_enqueue_script( 'logo-awesomeness-customizer', get_template_directory_uri() . '/js/logo/customize-preview.js', array( 'jquery', 'customize-preview' ), '201709081119', true );
}
...
function logo_awesomeness_customize_controls_js() {
	wp_enqueue_script( 'logo-awesomeness-customizer-controls', get_template_directory_uri() . '/js/logo/customize-controls.js', array( 'jquery', 'customize-controls' ), '20171020', true );
}
