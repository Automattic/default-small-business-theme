<?php
/**
 * smallbusinesstheme Theme Customizer
 *
 ...
 */
function smallbusinesstheme_customize_register( $wp_customize ) {
	...
	if ( isset( $wp_customize->selective_refresh ) ) {
		$wp_customize->selective_refresh->add_partial( 'blogname', array(
			...
			'render_callback' => 'smallbusinesstheme_customize_partial_blogname',
		) );
		$wp_customize->selective_refresh->add_partial( 'blogdescription', array(
			'selector'        => '.site-description',
			'render_callback' => 'smallbusinesstheme_customize_partial_blogdescription',
		) );
	}
...
add_action( 'customize_register', 'smallbusinesstheme_customize_register' );
 ...
 * @return void
 */
function smallbusinesstheme_customize_partial_blogname() {
	bloginfo( 'name' );
}
 ...
 * @return void
 */
function smallbusinesstheme_customize_partial_blogdescription() {
 ...
 */
function smallbusinesstheme_customize_preview_js() {
 ...
 */
function smallbusinesstheme_customize_hide_front_page_title() {
...
add_action( 'wp_enqueue_scripts', 'smallbusinesstheme_customize_hide_front_page_title' );